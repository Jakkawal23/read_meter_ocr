...
model = YOLO("model/meter_number/best.pt")

reader = easyocr.Reader(['en'])

custom_config = r'--oem 3 --psm 7 -c tessedit_char_whitelist=0123456789'

def detect_and_read_meter(file):
    ...
    # Read QR Code
    # qr_data = ""
    qr_data = detect_and_read_qrcode(image)
...
def save_img(step_name, img):
    filename = f"detected/meter_number/{step_name}_{uuid.uuid4().hex}.jpg"
